...
class VehicleController extends Controller
{
    ...
    if($request->hasfile('image')){
        ...
        $PostAds->serviceName =$request->serviceName;
        ...
        $PostAds->modelYear =$request->modelYear;
        $PostAds->fuelType =$request->fuelType;
        $PostAds->powerSource =$request->powerSource;
        $PostAds->capacity =$request->capacity;
        $PostAds->loadCapacity =$request->loadCapacity;
        $PostAds->goodsSupported =$request->goodsSupported;
        $PostAds->specialFeatures =$request->specialFeatures;
        $PostAds->workersAvailable =$request->workersAvailable;
        $PostAds->experienceSkills =$request->experienceSkills;
        $PostAds->certifications =$request->certifications;
        $PostAds->status =1;
        $PostAds->save();
