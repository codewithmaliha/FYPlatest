            ...
            <div class="row">
                <div class="large-12 columns">
                    <h1 id="page-title" class="title">
                        {{  $DetailAD->type == 'agriculture-machinery' ? 'Agriculture Machinery' :
                            ($DetailAD->type == 'agriculture-vehicle' ? 'Agriculture Vehicle' :
                            ($DetailAD->type == 'loading-vehicle' ? 'Loading Vehicle' :
                            ($DetailAD->type == 'labour' ? 'Labour' : '')))}}
                    </h1>
                </div>
            </div>
        </section>
