            ...
            <div class="site-title-bar" data-responsive-toggle="mobile-menu" data-hide-for="large">
                <div class="title-bar-left"> <button aria-label="Main Menu" class="menu-icon menu-toggle"
                        type="button"></button> <span class="site-mobile-title title-bar-title logo"> <a
                            ...
                            class="active"><noscript><img src="wp-content/themes/backhoe/images/logo.png"
            ...
            <nav class="site-navigation top-bar">
                ...
                <div class="top-bar-right">
                    <ul id="menu-primary-menu" class="desktop-menu menu">
                        <li
                            class=" menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-636 current_page_item active   color-2 menu-item-home">
                        ...
                        <li
                            ...
                            <ul class="submenu is-dropdown-submenu ">
                                <li
                                    ...
                                    <a href="about/index.html">About us</a><svg width="100px" height="100px"
...
49.8095238 L70.3007856,24.1428571 L64.2258065,29.575914 L82.5016759,45.9206349 Z"> </path>
                        ...
                        <li
                            class=" menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children   is-dropdown-submenu-parent opens-right not-click has-dropdown not-click  color-6 menu-item-has-children">
...
49.8095238 L70.3007856,24.1428571 L64.2258065,29.575914 L82.5016759,45.9206349 Z"> </path>
                    ...
                    <div class="header-cta show-for-large-up large-screen"> <a href="contact-us-2/index.html"
                    ...
                    <nav class="mobile-menu vertical menu" id="mobile-menu">
                        <ul id="menu-primary-menu-1" class="vertical menu" data-accordion-menu
                            ...
                            <li id="menu-item-5424"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-636 current_page_item menu-item-5424">
                                    ...
                                    <li id="menu-item-5352"
                                        ...
                                        <ul class="vertical nested menu">
                                            ...
                                            <li id="menu-item-5353"
                                                ...
                                                <a href="product/cw16-9-wheel/index.html">Product For Sale</a>
                                            </li>
