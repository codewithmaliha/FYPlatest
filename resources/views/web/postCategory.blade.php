            ...
            <div class="row">
                <div>
                    <h2 id="page-title" class="title">
                        ...
                        {{  $post[0]->type == 'agriculture-machinery' ? 'Agriculture Machinery' :
                            ($post[0]->type == 'agriculture-vehicle' ? 'Agriculture Vehicle' :
                            ($post[0]->type == 'loading-vehicle' ? 'Loading Vehicle' :
                            ($post[0]->type == 'labour' ? 'Labour' : '')))}}
